...
use crate::eth::{addr_from_raw_pubkey, decode_contract_call, EthCoin, EthCoinType, MakerPaymentStateV2, SignedEthTx,
                 TryToAddress, ERC1155_CONTRACT, ERC721_CONTRACT, ETH_GAS, NFT_MAKER_SWAP_V2_CONTRACT};
...
impl EthCoin {
    ...
    fn prepare_spend_nft_maker_v2_data(
        ...
        let spend_func = match args.contract_type {
            ContractType::Erc1155 => NFT_MAKER_SWAP_V2_CONTRACT.function("spendErc1155MakerPayment")?,
            ContractType::Erc721 => NFT_MAKER_SWAP_V2_CONTRACT.function("spendErc721MakerPayment")?,
        };
