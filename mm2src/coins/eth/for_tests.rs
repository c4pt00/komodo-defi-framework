...
pub(crate) fn eth_coin_from_keypair(
    ...
    let eth_coin = EthCoin(Arc::new(EthCoinImpl {
        ...
        maker_swap_v2_contract: Address::from_str(ETH_SEPOLIA_SWAP_CONTRACT).unwrap(),
        taker_swap_v2_contract: Address::from_str(ETH_SEPOLIA_SWAP_CONTRACT).unwrap(),
        nft_maker_swap_v2_contract: None,
