...
pub struct SendTakerFundingArgs<'a> {
    ...
    /// The hash of the secret generated by the taker, needed to reveal for immediate refund
    pub taker_secret_hash: &'a [u8],
    /// The hash of the secret generated by the maker, needed to reveal to spend the payment
