...
pub struct SendTakerFundingArgs<'a> {
    /// Taker will be able to refund the funding tx after this timestamp
    pub funding_time_lock: u64,
    /// Taker will be able to refund the payment tx after this timestamp
    ...
    /// The hash of the secret generated by maker, this needs to be revealed to spend the payment
