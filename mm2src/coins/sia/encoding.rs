...
impl Encoder {
    ...
    pub fn write_distiguisher(&mut self, p: &str) {
...
fn test_encoder_default_hash() {
    assert_eq!(Encoder::default().hash(), H256::from("0e5751c026e543b2e8ab2eb06099daa1d1e5df47778f7787faab45cdf12fe3a8"))
}
...
fn test_encoder_write_bytes() {
    ...
    assert_eq!(encoder.hash(), H256::from("d4a72b52e2e1f40e20ee40ea6d5080a1b1f76164786defbb7691a4427f3388f5"));
}
...
fn test_encoder_reset() {
    ...
    assert_eq!(encoder.hash(), H256::from("03170a2e7597b7b7e3d84c05391d139a62b157e78786d8c082f29dcf4c111314"));
}
...
fn test_encoder_complex() {
    ...
    encoder.write_u8(1);
    encoder.write_bytes(&[1, 2, 3, 4]);
    assert_eq!(encoder.hash(), H256::from("b66d7a9bef9fb303fe0e41f6b5c5af410303e428c4ff9231f6eb381248693221"));
}