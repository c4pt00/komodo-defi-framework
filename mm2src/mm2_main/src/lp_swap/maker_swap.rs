...
impl MakerSwap {
    ...
    pub async fn new(
        ...
        let db_id = maker_coin.account_db_id().await;
        MakerSwap {
            maker_coin,
            taker_coin,
            maker_amount,
...
impl MakerSavedSwap {
    pub fn new(maker_amount: &MmNumber, taker_amount: &MmNumber) -> MakerSavedSwap {
        ...
        MakerSavedSwap {
            ...
            success_events: vec![],
            error_events: vec![],
            maker_coin_account_id: None,
            taker_coin_account_id: None,
        }
    }
}
...
mod maker_swap_tests {
    ...
    fn test_recover_funds_maker_swap_payment_errored_but_sent() {
        ...
        let (maker_swap, _) = block_on(MakerSwap::load_from_saved(
            ctx,
            maker_coin,
            taker_coin,
            maker_saved_swap,
    ...
    fn swap_must_not_lock_funds_by_default() {
        ...
        let maker_coin = MmCoinEnum::Test(TestCoin::default());
        let taker_coin = MmCoinEnum::Test(TestCoin::default());
        let (_maker_swap, _) = block_on(MakerSwap::load_from_saved(
            ctx.clone(),
            maker_coin,
            taker_coin,
            maker_saved_swap,
